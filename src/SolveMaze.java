...
public class SolveMaze extends JFrame{
    ...
    public SolveMaze(String str){
        ...
        //Color map - we set map[][] in loadMap (function below)
    ...
    //LOADS THE ALREADY CREATED MAP (actually does by populating map[x][y] for all rows/columns) 
    	//then will actually display the map in the constructor of Maze (just above)
